...
import { computed, onMounted, onUnmounted, ref, watch, watchEffect, type ComponentPublicInstance } from 'vue';
...
useExamQuestionScrollToTop([currentIndex, () => props.subject]);
